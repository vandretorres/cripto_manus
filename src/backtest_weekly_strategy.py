    ...
    for current_date in all_dates:
        ...
        if day_of_week == 0: # Segunda-feira
            ...
            for symbol, data in all_data.items():
                ...
                features = latest_data_point.drop(labels=[col for col in latest_data_point.index if 'label' in col or 'timestamp' in col])
